...
var Bubbles = function () {
    ...
    Bubbles.prototype.addBgBubble = function addBgBubble() {
        this.aBgBubbles.push(new Bubble('#ffe162', 3.5)); // Color for the bubbles in the back
    };
...
var Bubble = function () {
    function Bubble() {
        var _c = arguments.length <= 0 || arguments[0] === undefined ? '#7d5cf7' : arguments[0]; // Color for the bubbles on the front
