(function($){
	...
	/*-------------------- COUNTDOWN -------------------*/
	// var countDownDate = new Date("Oct 17, 2021 19:00:00").getTime();
	if( $( '#clockdiv' )[0] ){
		function getTimeRemaining(endtime) {
			var t = Date.parse(endtime) - Date.parse(new Date());
			// var t = Date.parse(endtime) - countDownDate;
		...
		// var deadline = new Date(Date.parse(new Date("Oct 17, 2021 19:00:00").getTime()) + 17 * 24 * 60 * 60 * 1000);
		// var deadline = new Date(Date.parse(new Date()) + 31 * 24 * 60 * 60 * 1000).getTime();
		// var deadline = new Date(Date.parse(new Date("Oct 17, 2021 19:00:00").getTime() + 31 * 24 * 60 * 60 * 1000));
		var deadline = new Date(Date.parse(new Date("Oct-15-2021")) + 1 * 24 * 60 * 60 * 1000);
		// var deadline = new Date(Date.parse(new Date("Oct 15, 2021 19:00:00").getTime()));
